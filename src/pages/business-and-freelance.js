...
export const businessFreelanceQuery = graphql`
  query BusinessFreelanceQuery {
    site {
      siteMetadata {
        city
        state
    ...
    allAirtable(filter: { data: { Approved: { eq: "Yes" }, Category: { in: ["Business & Freelancers", "Professional & Career"] } } } ) {
      nodes {
        data {
          Approved
          ResourceName
