...
export const foodFinanceQuery = graphql`
  query FoodFinanceQuery {
    site {
      siteMetadata {
        city
        state
    ...
    allAirtable(filter: { data: { Approved: { eq: "Yes" }, Category: { in: ["Financial Stability", "Food Insecurity", "Soup Kitchens"] } } } ) {
      nodes {
        data {
          Approved
          ResourceName
