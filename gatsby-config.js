...
module.exports = ({ authorName, authorLink, remixAuthorName, remixAuthorLink }) => {
  return {
    siteMetadata: {
      ...
      remixAuthorName: remixAuthorName || `Henry Quinn`,
      remixAuthorLink: remixAuthorLink || `https://henryneeds.coffee`,
